# 22년도 2학기 기말고사 디지털영상처리 1번 문항 

# 1. 도형을 인식하고, 외곽에 테두리 선으로 표시하고, 인식결과를 도형 속에 글씨로 나타내시오.
...
def setLabel(image, str, contour):
  ...
  cv.rectangle(image, (pt_x, pt_y + baseline),
               (pt_x + text_width, pt_y - text_height), (200, 200, 200),
               cv.FILLED)
  cv.putText(image, str, (pt_x, pt_y), cv.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0),
             1, 8)
...
ret, img_binary = cv.threshold(img_gray, 127, 255,
